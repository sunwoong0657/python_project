...
c.pack()
c.create_oval(28, 18, 150, 100, width=5, outline="blue", fill="purple")
c.create_line(0, 0, 250, 200, width=9, fill= "blue")
c.create_rectangle(50, 300, 80, 60, width=4, outline="gray", fill="red")
...
c = Canvas(win, width=600, height=400)
img = PhotoImage(file="C:/Users/sunwo/PycharmProjects/python_project/python_project/img.png")
...
def drawDot(event):
    ...
    c.create_oval(x1, y1, x2, y2, fill='purple')
...
class Application:
    def __init__(self, root):
        h_btn = Button(root, text="클릭", command=self.hello)
        h_btn.pack(side="left")
        q_btn = Button(root, text="Quit", command=root.quit)
