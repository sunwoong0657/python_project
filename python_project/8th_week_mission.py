...
pen_size = 30              # 펜 굵기
rainbow_color = ['red', 'orange', 'yellow', 'green', 'blue', 'navy', 'purple', 'gray', 'black']      # 활용할 색상 지정
...
def draw_rainbow(t, rainbow_size, pen_size, x, y):
    ...
    """
    # 설정(작성할 부분1)
    rainbow_color = ['red', 'orange', 'yellow', 'green', 'blue', 'navy', 'purple', 'gray', 'black']
    t.pensize(pen_size)
    # 그리기(작성할 부분2)
    for i range(7):
        t.setheading(90)
