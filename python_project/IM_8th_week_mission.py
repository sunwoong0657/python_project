...
class GalagaGame():
    ...
    def __init__(self, master):
        self.master = master                                                    # 객체 생성
        self.sprites = []
        self.canvas = Canvas(master, width=800, height=600)
        self.canvas.pack()
        # 이미지 생성
        self.shotImage = PhotoImage(r"C:\Users\sunwo\PycharmProjects\python_project\python_project\fire.png")
        self.shipImage = PhotoImage(r"C:\Users\sunwo\PycharmProjects\python_project\python_project\starship.png")
        self.alienImage = PhotoImage(r"C:\Users\sunwo\PycharmProjects\python_project\python_project\alien.png")
        # 게임실행 여부 & sprite 초기화
        self.running = True
        self.initSprites()
        # 이벤트 처리(7가지 이벤트 처리)
        ...
        master.bind("<Return>", self.startGame)             # startGame() 메서드: 게임시작 메서드(Enter키의 이벤트 핸들러)
